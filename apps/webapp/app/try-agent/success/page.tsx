...
export default function SuccessPage() {
  // Get the selected agent from localStorage (in a real app, this would come from your backend)
  const selectedAgentId = typeof window !== "undefined" ? localStorage.getItem("trialAgentId") : null
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm">
                      <span className="font-medium">Log in to your dashboard</span> using the provided credentials
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm">
                      <span className="font-medium">Upgrade to Pro</span> to unlock unlimited messages and multiple
                      agents
                    </p>
                  </div>
                </div>
