    ...
    <footer className="border-t bg-background">
      <div className="container py-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Discover and deploy powerful AI agents for your business and personal needs.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/categories/data" className="text-muted-foreground hover:text-foreground transition-colors">
                  Data Analysis
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 border-t pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} AI Agents Marketplace. All rights reserved.
          </p>
